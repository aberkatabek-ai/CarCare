    ...
    const dictionaries = {
        tr: {
            exact: {
                ...
                "Keep the beige background and choose the accent color you prefer.": "Bej arka planı koru ve tercih ettiğin vurgu rengini seç.",
                "Accent color options": "Vurgu rengi seçenekleri",
                "Graphite": "Grafit",
                "Blue": "Mavi",
                "Green": "Yeşil",
                "Red": "Kırmızı",
                "Accent color saved for this device.": "Vurgu rengi bu cihaz için kaydedildi.",
        ...
        ru: {
            exact: {
                ...
                "Keep the beige background and choose the accent color you prefer.": "Сохраните бежевый фон и выберите акцентный цвет по своему вкусу.",
                "Accent color options": "Варианты акцентного цвета",
                "Graphite": "Графит",
                "Blue": "Синий",
                "Green": "Зеленый",
                "Red": "Красный",
                "Accent color saved for this device.": "Акцентный цвет сохранен для этого устройства.",
        ...
        es: {
            exact: {
                ...
                "Keep the beige background and choose the accent color you prefer.": "Mantén el fondo beige y elige el color de acento que prefieras.",
                "Accent color options": "Opciones de color de acento",
                "Graphite": "Grafito",
                "Blue": "Azul",
                "Green": "Verde",
                "Red": "Rojo",
                "Accent color saved for this device.": "El color de acento se guardó para este dispositivo.",
